...
![](https://user-gold-cdn.xitu.io/2019/5/18/16ac8bd43cedb8b2?w=1120&h=870&f=png&s=128287)
#### 我们按照这个步骤一个一个的来。
### 修改主机名
...
* 192.168.20.193 os3
* 192.168.20.143 os4
![](https://user-gold-cdn.xitu.io/2019/5/18/16ac8c49a848130b?w=1098&h=218&f=png&s=46050)
...
#### 主机
![](https://user-gold-cdn.xitu.io/2019/5/18/16ac8ecb5cd8a0e3?w=580&h=206&f=png&s=39318)
#### 从机
![](https://user-gold-cdn.xitu.io/2019/5/18/16ac8ed2d55b96a2?w=452&h=114&f=png&s=17433)
#### 启动之后有问题？莫捉急👇
***
# 问题总结
...
![二话不说看图](https://user-gold-cdn.xitu.io/2019/3/28/169c2528f76cd408?w=1318&h=1158&f=png&s=361103)
#### 进入这个文件然后复制当中的cluster_id
![输入图片说明](https://user-gold-cdn.xitu.io/2019/3/28/169c2528f78bde04?w=2138&h=890&f=png&s=280861)
#### 将这个id复制到你core-site.xml中修改的hadoop.tmp.dir标签的路径/dfs/data/current 下的VERSION文件(如图)
![输入图片说明](https://user-gold-cdn.xitu.io/2019/3/28/169c2528f774b548?w=774&h=224&f=png&s=37667)
#### 然后重新启动服务即可
...
![](https://user-gold-cdn.xitu.io/2019/5/17/16ac5aa9738b643a?w=920&h=276&f=png&s=77203)
#### Permission denied (publickey,gssapi-keyex,gssapi-with-mic,password).
#### 这个错误是因为：~/.ssh/authorized_keys文件的权限没有给够执行👇(每台机器)
`chmod 644 authorized_keys`
#### 上传文件的时候
![](https://user-gold-cdn.xitu.io/2019/5/17/16ac5b702c2ae720?w=2278&h=528&f=png&s=384813)
#### 原因是没有将上传文件的服务器防火墙关闭。
